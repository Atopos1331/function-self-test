...
getPageSize : function () {
	...
	var b = document.body,
		m = (window.innerHeight && window.scrollMax);
	var xScroll = m ? window.innerWidth + window.scrollMaxX :
			(b.scrollWidth > b.offsetWidth ? b.scrollWidth : b.offsetWidth),
		yScroll = m ? window.innerHeight + window.scrollMaxY :
	...
	return {
		pageWidth: xScroll < width ? width : xScroll,
